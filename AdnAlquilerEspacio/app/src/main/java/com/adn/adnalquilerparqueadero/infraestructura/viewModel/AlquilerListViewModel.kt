...
import com.adn.adnalquilerparqueadero.dominio.servicios.listar.ISeviceListarVehiculos
...
class AlquilerListViewModel constructor(private val servicioListarVehiculos: ISeviceListarVehiculos) :
    ViewModel()
{
